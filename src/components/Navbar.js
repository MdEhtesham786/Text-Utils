                    ...
                    <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li className="nav-item dropdown">
                            ...
                            <ul className={`dropdown-menu bg-black bg-${props.bgColor}`} aria-labelledby="navbarDropdown" >
                                <li><Link className={`dropdown-item text-${props.txtColor}`} to="/">Action</Link></li>
                                <li><Link className={`dropdown-item text-${props.txtColor}`} to="/">Another action</Link></li>
                                <li><hr className={`dropdown-divider text-${props.txtColor}`} /></li>
                                <li><Link className={`dropdown-item text-${props.txtColor}`} to="/">Something else here</Link></li>
                            </ul>
                        </li>
                    </ul>
